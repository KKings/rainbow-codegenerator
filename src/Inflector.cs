namespace Rainbow.CodeGenerator
{
    ...
    {
        private static readonly IList<Rule> Plurals = new List<Rule>();
        private static readonly IList<Rule> Singulars = new List<Rule>();
        ...
        private class Rule
        {
            ...
            {
                return !this._regex.IsMatch(word) ? null : this._regex.Replace(word, this._replacement);
            }
        }
